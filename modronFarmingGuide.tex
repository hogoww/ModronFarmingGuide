...
I'm sure this never happens to any of the great players that read this guide, but the grandparents of the friends of my friends keep having stackless briv, which slows down their next run.
...
%Grand Tour & The Mad Wizard & Pure Energy \\
%Tomb of Annihilation & The Ring of Regeneration & The death curse & too long to test \\
Dragon Heist & The Botched Kidnapping & This Quest Stinks! \\
Dragon Heist & Attack on the Manor & Review by the Blackstaff \\
%Dragon Heist & Nimble Escape & Distracted Escape && meh (difficult to put in place if no character is unlocked by default)\\
\bottomrule
\end{tabular}
\end{small}
\end{table}
...
\subsection{Using Potions in Modron Resets}
